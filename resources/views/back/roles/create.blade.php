    ...
    <form action="{{ route('back.roles.store') }}" method="POST">
      <div class="row card-body">
        ...
        <div class="col-md-4 mb-4">
          ...
          <input type="text" name="name" class="form-control" id="name" placeholder="Enter a name" value="{{ old('name')}}">
        ...
        <div class="col-md-8 mb-4">
          ...
          <input type="text" name="description" class="form-control" id="description" placeholder="Enter a description" value="{{ old('description')}}">
          <div class="form-text text-danger">
          ...
          <div class="row">
            ...
            <div class="form-text text-danger">
              ...
              <div class="row" style="max-height: 146px; overflow-y:auto">
                ...
                <div class="col-sm-1 my-2 mx-1 p-0">
