    ...
    <form action="{{ route('back.users.update', $user->id) }}" method="POST">
      <div class="row card-body">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="name" class="form-control" id="name" value="{{ $user->name }}" placeholder="Enter a name">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="email" class="form-control" id="email" value="{{ $user->email }}" placeholder="Enter an email">
